...
#define SAMPLE_TIME_S		0.03	//1
#define RAD_TO_DEG			57.2957795131
#define DEG_TO_RAD			0.0174532925f
#define alpha               0.03
#define alphaACC 			1.9f   //alpha defines the weight of gyroscope in respect tos accelerometer in angular position
#define alphaGYRO 			0.1f   //alpha defines the weight of gyroscope in respect tos accelerometer in angular position
...
typedef struct imuStruct
{
    ...
    volatile float acc_ms2[3];
    volatile float mag_xx[3];        //se houver um magnetometro externo
